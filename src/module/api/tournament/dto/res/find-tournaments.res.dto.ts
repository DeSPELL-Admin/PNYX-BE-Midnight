...
import { TournamentStatus } from '../../tournament.util';
import { BettingType, TournamentGenre } from 'src/module/common/util/enum.util';

@Exclude()
export class FindTournamentsResDto {
    @ApiProperty({
        description: '카테고리',
        example: 'Animation',
        type: String,
    ...
    @ApiProperty({
        description: '로그인 사용자의 해당 토너먼트 플레이 완료 여부',
        enum: TournamentStatus,
        example: TournamentStatus.INCOMPLETE,
    })
    @Expose()
